...
class CWorldServer : public CServerSocket
{
    public:
        ...
        bool pakNPCAction( CPlayer* thisclient, CPacket* pak );
        bool nextquestAction( CPlayer* thisclient, DWORD hash );
        bool pakEventTrigger( CPlayer* thisclient, unsigned triggerid );
